...
const ProductGridPage = () => {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-cyan-50 flex items-center justify-center p-6">
              ...
              {products.map((product) => (
                ...
                >
                  ...
                  <div className="h-80 bg-gradient-to-br from-pink-100/40 to-cyan-100/40 overflow-hidden relative">
                    ...
                    <div className="absolute top-4 right-4 bg-gradient-to-r from-pink-500 to-cyan-500 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg">
                      Rekomendasi
                    </div>
                  </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fadeIn">
          <div className="relative bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl animate-slideUp">
            ...
            <div className="grid md:grid-cols-2 gap-8 p-8">
              {/* Product Image */}
              <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-pink-100/40 to-cyan-100/40">
              ...
              <div className="flex flex-col justify-between">
                ...
                <div>
                  <button
                    onClick={handleCloseModal}
                    className="w-full px-8 py-4 bg-gradient-to-r from-pink-500 to-cyan-500 rounded-xl text-white font-bold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
                  >
                    Tutup
                  </button>
                </div>
