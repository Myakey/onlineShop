  ...
  return (
    ...
    >
      <div className="relative">
        ...
        />
        <span className="absolute top-3 left-3 bg-gradient-to-r from-pink-400 to-sky-400 text-white text-xs px-2 py-1 rounded-lg shadow-md">
          Best Seller
        </span>
      </div>
      <div className="p-5 flex flex-col justify-between flex-1">
        <div>
          <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-pink-600 transition">
            {product.name}
          </h3>
