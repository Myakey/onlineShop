...
const Navbar = ({ currentPage = "home" }) => {
  ...
  const navItems = [
    {
      ...
      key: "home",
      path: "/dashboard",
      description: "Halaman utama toko boneka dengan koleksi terbaru",
    },
    {
      name: "Product",
      key: "product",
      path: "/product",
      description: "Jelajahi koleksi boneka lucu & imut",
    },
    {
      name: "Reviews",
      key: "reviews",
      path: "/reviews",
      description: "Baca ulasan pelanggan tentang boneka kami",
    },
    {
      name: "Order",
      key: "order",
      path: "/order",
      description: "Pesan boneka favoritmu sekarang",
    },
  ];
  ...
  const handleNavClick = (path, key) => {
    ...
    setIsMenuOpen(false);
    navigate(path); // ✅ langsung navigasi ke halaman
  };
